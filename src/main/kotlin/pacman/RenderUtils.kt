...
/**
 * Renders a black cutout over Pac-Man to simulate the opening and closing mouth.
 */
fun drawPacmanMouthCutout(s: Surface, cx: Float, cy: Float, radius: Float, dir: Direction, open: Float) {
