...
/**
 * Renders the primary gameplay elements including the maze, Pac-Man, ghosts, and fruit.
 *
...
class GameplayRenderer(
    ...
    /**
     * Renders Pac-Man at his current position with appropriate mouth animation or death sequence.
     */
    fun renderPacman(s: Surface, phase: GamePhase, deathAnimTimer: Float) {
    ...
    /**
     * Renders subtle bloom halos around Pac-Man, ghosts, and fruit.
     */
